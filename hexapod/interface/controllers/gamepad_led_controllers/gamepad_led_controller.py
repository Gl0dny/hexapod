...
class BaseGamepadLEDController(ABC):
    ...
    def set_color(
        self, color: GamepadLEDColor, brightness: Optional[float] = None
    ) -> bool:
        """
    ...
    def set_color_rgb(
        self, rgb: Tuple[int, int, int], brightness: Optional[float] = None
    ) -> bool:
        """
    ...
    def pulse(
        self, color: GamepadLEDColor, duration: float = 1.0, cycles: int = 1
    ) -> bool:
        """
        ...
        self.animation_thread = threading.Thread(
            target=self._pulse_animation, args=(color, duration, cycles), daemon=True
        )
    ...
    def pulse_two_colors(
        self,
        color1: GamepadLEDColor,
    ...
    def _pulse_two_colors_animation(
        self,
        color1: GamepadLEDColor,
        color2: GamepadLEDColor,
        duration: float,
    ...
    def breathing_animation(
        self, color: GamepadLEDColor, duration: float = 2.0, cycles: int = 1
    ) -> bool:
        """
