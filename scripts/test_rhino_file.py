...
def test_rhino_on_file(input_file: Path, access_key: str):
    ...
    context_path = (
        ...
        / "kws"
        / "rhino"
        / "hexapod_en_raspberry-pi_v3_0_0.rhn"
    )
    ...
    # Initialize Rhino
    rhino = pvrhino.create(access_key=access_key, context_path=str(context_path))
...
def main():
    parser = argparse.ArgumentParser(
        description="Test Rhino speech-to-intent on a WAV file"
    )
    ...
    test_rhino_on_file(Path(args.input_file), args.access_key)
