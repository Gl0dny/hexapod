...
class InteractiveHexapodController:
    ...
    def show_current_position(self):
        ...
        print(f"\nCurrent Position:")
        print(
            f"  Translation: X={self.current_tx:6.1f}, Y={self.current_ty:6.1f}, Z={self.current_tz:6.1f} mm"
        )
        print(
            f"  Rotation:    Roll={self.current_roll:6.1f}, Pitch={self.current_pitch:6.1f}, Yaw={self.current_yaw:6.1f}°"
        )
    ...
    def execute_movement(self, tx=0.0, ty=0.0, tz=0.0, roll=0.0, pitch=0.0, yaw=0.0):
        ...
        try:
            ...
            print(
                f"Movement executed: tx={tx}, ty={ty}, tz={tz}, roll={roll}, pitch={pitch}, yaw={yaw}"
            )
