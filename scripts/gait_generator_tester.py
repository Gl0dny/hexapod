...
def main():
    ...
    print(
        "Leg numbering: 0=Right, 1=Right Front, 2=Left Front, 3=Left, 4=Left Back, 5=Right Back"
    )
    ...
    try:
        ...
        for i, pos in enumerate(hexapod.current_leg_positions):
            ...
            print(
                f"  Leg {i} ({leg_names[i]}): ({pos[0]:.1f}, {pos[1]:.1f}, {pos[2]:.1f})"
            )
        ...
        hexapod.gait_generator.create_gait(
            gait_type="tripod", step_radius=22.0, leg_lift_distance=20.0, dwell_time=0.1
        )
