...
# Mock external dependencies BEFORE any imports (similar to conftest.py)
import unittest.mock as mock

# Mock external dependencies that are not available in local environment
...
def main():
    ...
    try:
        # Initialize Hexapod instance (dependencies are already mocked)
        hexapod = Hexapod(
