...
class TestImu:
    def test_get_acceleration(self, imu_fixture):
    ...
    def test_get_gyroscope(self, imu_fixture):
        mock_instance, imu = imu_fixture
        mock_instance.read_accelerometer_gyro_data.return_value = (0.01, 0.01, 1.01, 0.46, 1.14, -0.35)
    ...
    def test_get_magnetometer(self, imu_fixture):
        mock_instance, imu = imu_fixture
    ...
    def test_get_temperature(self, imu_fixture):
        mock_instance, imu = imu_fixture
