...
class TestBaseGait:
    ...
    def test_calculate_leg_path_swing_with_movement(self, concrete_gait):
        ...
        assert path.waypoints[0].z == 0  # Start at current height
        assert path.waypoints[1].z == target.z + concrete_gait.leg_lift_distance  # Lift and move
    ...
    def test_calculate_leg_target_translation_stance_full_circle_with_movement(self, concrete_gait):
    ...
    def test_calculate_leg_target_translation_stance_half_circle_with_movement(self, concrete_gait):
