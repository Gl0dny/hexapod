...
class TestButtonHandler:
    ...
    def button_handler_custom(self, mock_gpio):
        ...
        return ButtonHandler(
            pin=18,
            long_press_time=2.0,
            external_control_paused_event=event
        )
    ...
    def test_gpio_setup(self, mock_gpio):
        ...
        mock_gpio.setup.assert_called_once_with(15, mock_gpio.IN, pull_up_down=mock_gpio.PUD_UP)
    ...
    def test_check_button_long_press_with_external_control_paused(self, button_handler_custom, mock_gpio):
    ...
    def test_check_button_long_press_then_release(self, button_handler_default, mock_gpio):
    ...
    def test_external_control_paused_event_none(self, button_handler_default, mock_gpio):
    ...
    def test_external_control_paused_event_not_set(self, button_handler_custom, mock_gpio):
    ...
    def test_long_press_time_custom(self, button_handler_custom, mock_gpio):
        ...
        with patch('hexapod.robot.sensors.button_handler.time.time') as mock_time:
            mock_time.side_effect = [0, 1.5, 2.5]  # Start, before threshold, after threshold
