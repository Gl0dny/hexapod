...
class TestImu:
    ...
    def mock_icm20948(self):
        ...
        mock_imu = Mock()
        mock_imu.read_accelerometer_gyro_data.return_value = (
            0.01,
            0.01,
            1.01,
            0.46,
    ...
    def test_init_default_parameters(self, mock_icm20948):
        ...
        with patch(
            "hexapod.robot.sensors.imu.ICM20948", return_value=mock_icm20948
        ) as mock_icm:
            imu = Imu()
    ...
    def test_get_acceleration_custom_data(self, mock_icm20948):
        ...
        mock_icm20948.read_accelerometer_gyro_data.return_value = (
            1.5,
            -2.3,
            9.8,
            0.0,
    ...
    def test_read_all_sensor_data(self, imu, mock_icm20948):
        ...
        assert (
            mock_icm20948.read_accelerometer_gyro_data.call_count == 2
        )  # Called for accel and gyro
    ...
    def test_error_handling_i2c_failure(self, mock_icm20948):
        ...
        # Mock I2C failure
        mock_icm20948.read_accelerometer_gyro_data.side_effect = Exception(
    ...
    def test_error_handling_sensor_failure(self, mock_icm20948):
        ...
        # Mock sensor failure
        mock_icm20948.read_magnetometer_data.side_effect = Exception(
            "Sensor read error"
        )
    ...
    def test_error_handling_temperature_failure(self, mock_icm20948):
        ...
        mock_icm20948.read_temperature.side_effect = Exception(
    ...
    def test_float_precision(self, mock_icm20948):
        ...
        mock_icm20948.read_magnetometer_data.return_value = (
            0.000000001,
            0.000000002,
            0.000000003,
        )
