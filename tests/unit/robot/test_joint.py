...
class TestJoint:
    ...
    def test_init_default_parameters(self, joint_default):
        ...
        assert joint_default.servo_min == Joint.SERVO_INPUT_MIN * Joint.SERVO_UNIT_MULTIPLIER
        assert joint_default.servo_max == Joint.SERVO_INPUT_MAX * Joint.SERVO_UNIT_MULTIPLIER
    ...
    def test_controller_communication_error(self, joint_default):
        ...
        joint_default.controller.set_target.side_effect = Exception("Communication error")
