...
def lights_default(mock_apa102, mock_led):
    ...
    with patch('hexapod.lights.lights.APA102', return_value=mock_apa102), \
...
class TestLights:
    ...
    def test_init_default_parameters(self, mock_apa102, mock_led):
        ...
        with patch('hexapod.lights.lights.APA102', return_value=mock_apa102) as mock_apa102_class, \
            ...
            mock_logger.info.assert_called_once_with("Lights initialized successfully with 12 LEDs.")
    ...
    def test_init_custom_parameters(self, mock_apa102, mock_led):
        ...
        with patch('hexapod.lights.lights.APA102', return_value=mock_apa102) as mock_apa102_class, \
            ...
            mock_led.on.assert_called_once()
            mock_logger.info.assert_called_once_with("Lights initialized successfully with 8 LEDs.")
