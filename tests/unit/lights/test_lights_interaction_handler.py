...
def handler_default(mock_lights, sample_leg_to_led):
    ...
    with (
        patch(
            "hexapod.lights.lights_interaction_handler.Lights", return_value=mock_lights
        ),
...
class TestLightsInteractionHandler:
    ...
    def test_init_default_parameters(self, mock_lights, sample_leg_to_led):
        ...
        with (
            patch(
                "hexapod.lights.lights_interaction_handler.Lights",
                return_value=mock_lights,
            ) as mock_lights_class,
            ...
            mock_logger.info.assert_called_once_with(
                "LightsInteractionHandler initialized successfully."
            )
    ...
    def test_stop_animation_with_active_animation(
        self, handler_default, mock_animation
    ):
        ...
        with patch("hexapod.lights.lights_interaction_handler.logger") as mock_logger:
            ...
            mock_logger.info.assert_called_with(
                f"Stopping currently running animation {mock_animation}"
            )
    ...
    def test_set_single_color_specific_led(self, handler_default):
        ...
        with patch("hexapod.lights.lights_interaction_handler.logger") as mock_logger:
            ...
            handler_default.lights.clear.assert_called_once()
            handler_default.lights.set_color.assert_called_once_with(
                ColorRGB.BLUE, led_index=5
            )
    ...
    def test_anim_decorator_success(self, handler_default, mock_animation):
        ...
        with (
            patch("hexapod.lights.lights_interaction_handler.logger") as mock_logger,
            patch(
                "hexapod.lights.lights_interaction_handler.animations.WheelFillAnimation",
                return_value=mock_animation,
            ),
        ):
            ...
            )  # "No active animation to stop." + "Starting animation rainbow."
            mock_logger.debug.assert_called_with(
                f"'rainbow' successfully set animation attribute: {mock_animation}"
            )
    ...
    def test_anim_decorator_missing_animation_attribute(self, handler_default):
        ...
        with patch("hexapod.lights.lights_interaction_handler.logger") as mock_logger:
            with pytest.raises(
                AttributeError, match="bad_method must set 'self.animation' attribute"
            ):
                decorated_method(handler_default)

            mock_logger.error.assert_called_with(
                "bad_method must set 'self.animation' attribute."
            )
    ...
    def test_anim_decorator_exception_handling(self, handler_default):
        ...
        with patch("hexapod.lights.lights_interaction_handler.logger") as mock_logger:
            ...
            mock_logger.exception.assert_called_with(
                "Error in error_method: Test error"
            )
    ...
    def test_rainbow_animation_custom(self, handler_default, mock_animation):
        ...
        with patch(
            ...
            handler_default.rainbow(
                use_rainbow=False, color=ColorRGB.BLUE, interval=0.5
            )
    ...
    def test_listen_wakeword_animation(self, handler_default, mock_animation):
        ...
        with patch(
            "hexapod.lights.lights_interaction_handler.animations.PulseSmoothlyAnimation",
            return_value=mock_animation,
        ):
            handler_default.listen_wakeword(
                base_color=ColorRGB.RED, pulse_color=ColorRGB.YELLOW, pulse_speed=0.1
            )
    ...
    def test_listen_intent_animation(self, handler_default, mock_animation):
        ...
        with patch(
            "hexapod.lights.lights_interaction_handler.animations.AlternateRotateAnimation",
            return_value=mock_animation,
        ):
            handler_default.listen_intent(
                color_even=ColorRGB.GREEN, color_odd=ColorRGB.RED, delay=0.3
            )
    ...
    def test_think_animation(self, handler_default, mock_animation):
        ...
        with patch(
            "hexapod.lights.lights_interaction_handler.animations.OppositeRotateAnimation",
            return_value=mock_animation,
        ):
            ...
            animations.OppositeRotateAnimation.assert_called_once_with(
                lights=handler_default.lights, interval=0.2, color=ColorRGB.PURPLE
            )

    def test_police_animation(self, handler_default, mock_animation):
        """Test police animation."""
        with patch(
            "hexapod.lights.lights_interaction_handler.animations.PulseAnimation",
            return_value=mock_animation,
        ):
    ...
    def test_update_calibration_leds_status(self, handler_default, mock_animation):
        ...
        with patch(
            "hexapod.lights.lights_interaction_handler.animations.CalibrationAnimation",
            return_value=mock_animation,
        ):
    ...
    def test_speak_animation_not_implemented(self, handler_default):
        ...
        with pytest.raises(
            NotImplementedError, match="The 'speak' method is not implemented yet."
        ):
            handler_default.speak()

    def test_direction_of_arrival_animation_default(
        self, handler_default, mock_animation
    ):
        """Test direction_of_arrival animation with default parameters."""
        with patch(
            "hexapod.lights.lights_interaction_handler.animations.DirectionOfArrivalAnimation",
            return_value=mock_animation,
        ):
    ...
    def test_direction_of_arrival_animation_custom(
        self, handler_default, mock_animation
    ):
        ...
        with patch(
            ...
            handler_default.direction_of_arrival(
                refresh_delay=0.2, source_colors=custom_colors
            )
    ...
    def test_pulse_smoothly_animation(self, handler_default, mock_animation):
        ...
        with patch(
            ...
            handler_default.pulse_smoothly(
                base_color=ColorRGB.GREEN, pulse_color=ColorRGB.BLACK, pulse_speed=0.1
            )
    ...
    def test_wheel_animation_default(self, handler_default, mock_animation):
        ...
        with patch(
            "hexapod.lights.lights_interaction_handler.animations.WheelAnimation",
            return_value=mock_animation,
        ):
    ...
    def test_wheel_animation_custom(self, handler_default, mock_animation):
        ...
        with patch(
            ...
            handler_default.wheel(
                use_rainbow=False, color=ColorRGB.ORANGE, interval=0.3
            )
    ...
    def test_all_animation_methods_call_off(self, handler_default, mock_animation):
        ...
        animation_methods = [
            ...
            (
                "update_calibration_leds_status",
        ...
        for method_name, animation_class, args in animation_methods:
            ...
            with patch(
                f"hexapod.lights.lights_interaction_handler.animations.{animation_class}",
                return_value=mock_animation,
            ):
    ...
    def test_leg_to_led_mapping_preserved(self, sample_leg_to_led):
        ...
        with (
            patch("hexapod.lights.lights_interaction_handler.Lights"),
            patch("hexapod.lights.lights_interaction_handler.logger"),
        ):
