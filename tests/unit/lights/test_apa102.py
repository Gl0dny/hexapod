...
class TestAPA102:
    ...
    def test_init_no_max_speed(self, mock_spi):
        ...
        with patch('hexapod.lights.apa102.spidev.SpiDev', return_value=mock_spi):
            ...
            assert not hasattr(apa102.spi, 'max_speed_hz') or apa102.spi.max_speed_hz != 0
    ...
    def test_init_spidev_not_available(self):
        ...
        with patch('hexapod.lights.apa102.spidev', None):
            with pytest.raises(ImportError, match="spidev module is required but not available"):
                APA102(num_led=10)
    ...
    def test_set_pixel_valid_colors(self, apa102_default):
        ...
        assert apa102_default.leds[start_index] == (0b11100000 | (expected_brightness & 0b00011111))
    ...
    def test_set_pixel_grb_order(self, apa102_custom):
        ...
        assert apa102_custom.leds[start_index] == (0b11100000 | (expected_brightness & 0b00011111))
    ...
    def test_set_pixel_invalid_colors(self, apa102_default):
        ...
        with pytest.raises(ValueError, match="red, green, and blue must be integers between 0 and 255"):
    ...
    def test_rotate_negative(self, apa102_default):
        ...
        assert apa102_default.leds[0:4] != initial_led0 or apa102_default.leds[4:8] != initial_led1
    ...
    def test_brightness_rounding(self, apa102_default):
        ...
        expected_brightness = int(ceil(1 * 31 / 100.0))  # Should be 0, but rounds up to 1
        assert apa102_default.leds[0] == (0b11100000 | expected_brightness)
