...
class TestPulseAnimation:
    ...
    def test_init_default_parameters(self, mock_lights):
        ...
        with patch('hexapod.lights.animations.pulse_animation.Animation.__init__') as mock_super_init:
    ...
    def test_execute_animation_multiple_pulse_cycles(self, animation_default, mock_lights):
    ...
    def test_execute_animation_stop_during_base_color(self, animation_default, mock_lights):
    ...
    def test_execute_animation_stop_during_pulse_color(self, animation_default, mock_lights):
