...
from hexapod.lights.animations.direction_of_arrival_animation import (
...
def animation_custom(mock_lights):
    ...
    return DirectionOfArrivalAnimation(
        lights=mock_lights, refresh_delay=0.2, source_colors=custom_colors
    )
...
class TestDirectionOfArrivalAnimation:
    ...
    def test_init_default_parameters(self, mock_lights):
        ...
        with patch(
            "hexapod.lights.animations.direction_of_arrival_animation.Animation.__init__"
        ) as mock_super_init:
            ...
            assert animation.source_colors == [
                ColorRGB.TEAL,
                ColorRGB.INDIGO,
                ColorRGB.YELLOW,
                ColorRGB.LIME,
    ...
    def test_execute_animation_more_than_four_sources(
    ...
    def test_execute_animation_azimuths_attribute_missing(
        self, animation_default, mock_lights
    ):
    ...
    def test_attributes_after_init(self, animation_custom):
        ...
        assert animation_custom.source_colors == [
            ColorRGB.RED,
            ColorRGB.BLUE,
            ColorRGB.GREEN,
        ]
