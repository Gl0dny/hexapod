...
class TestWheelFillAnimation:
    ...
    def test_init_default_parameters(self, mock_lights):
        ...
        with patch('hexapod.lights.animations.wheel_fill_animation.Animation.__init__') as mock_super_init:
    ...
    def test_init_validation_error(self, mock_lights):
        ...
        with patch('hexapod.lights.animations.wheel_fill_animation.Animation.__init__'), \
             patch('hexapod.lights.animations.wheel_fill_animation.logger') as mock_logger:
    ...
    def test_execute_animation_single_color_with_none_color(self, mock_lights):
        ...
        animation = WheelFillAnimation(lights=mock_lights, use_rainbow=True)  # Start with valid params
    ...
    def test_execute_animation_rainbow_vs_single_color_difference(self, mock_lights):
        ...
        assert len(single_wheel_calls) == 0  # Single color mode doesn't call get_wheel_color
    ...
    def test_execute_animation_different_intervals(self, mock_lights):
        ...
        animation_fast = WheelFillAnimation(
            lights=mock_lights,
            interval=0.01
        )
        ...
        mock_lights.reset_mock()
        animation_slow = WheelFillAnimation(
            lights=mock_lights,
            interval=2.0
        )
