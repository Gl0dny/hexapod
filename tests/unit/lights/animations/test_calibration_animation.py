...
class TestCalibrationAnimation:
    ...
    def test_init_default_parameters(self, mock_lights, sample_calibration_status, sample_leg_to_led):
        """Test initialization with default parameters."""
        with patch('hexapod.lights.animations.calibration_animation.Animation.__init__') as mock_super_init:
    ...
    def test_init_custom_parameters(self, mock_lights, sample_calibration_status, sample_leg_to_led):
    ...
    def test_execute_animation_multiple_iterations(self, animation_default, mock_lights):
        ...
        assert mock_lights.set_color.call_count == 24  # 6 legs * 4 iterations (including initial)
    ...
    def test_execute_animation_invalid_status(self, mock_lights, sample_leg_to_led):
        ...
        invalid_status = {
            0: "calibrating",
            1: "invalid_status"  # Invalid status
        }
        ...
        with pytest.raises(ValueError, match="Invalid calibration status: invalid_status"):
            animation.execute_animation()
    ...
    def test_execute_animation_empty_calibration_status(self, mock_lights, sample_leg_to_led):
    ...
    def test_execute_animation_empty_leg_to_led(self, mock_lights, sample_calibration_status):
    ...
    def test_attributes_after_init(self, animation_custom, sample_calibration_status, sample_leg_to_led):
