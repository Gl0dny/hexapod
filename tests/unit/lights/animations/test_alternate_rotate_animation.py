...
from hexapod.lights.animations.alternate_rotate_animation import (
...
class TestAlternateRotateAnimation:
    ...
    def test_init_default_parameters(self, mock_lights):
        ...
        with patch(
            "hexapod.lights.animations.alternate_rotate_animation.Animation.__init__"
        ) as mock_super_init:
    ...
    def test_execute_animation_stop_during_initial_setup(
    ...
    def test_execute_animation_stop_during_rotation(
        self, animation_default, mock_lights
    ):
    ...
    def test_execute_animation_continuous_rotation(
        self, animation_default, mock_lights
    ):
    ...
    def test_execute_animation_odd_number_of_leds(self, mock_lights):
        ...
        animation.stop_event.wait = Mock(
