...
class TestAnimation:
    ...
    def test_init(self, mock_lights):
        ...
        with patch('hexapod.lights.animations.animation.rename_thread') as mock_rename, \
            ...
            mock_logger.debug.assert_called_once_with("ConcreteAnimation initialized successfully.")
    ...
    def test_stop_animation_when_not_alive(self, concrete_animation):
        ...
        with patch('hexapod.lights.animations.animation.logger') as mock_logger:
            ...
            mock_logger.debug.assert_called_once_with("Stopping animation: ConcreteAnimation")
    ...
    def test_stop_animation_forceful_stop(self, concrete_animation):
        ...
        with patch('hexapod.lights.animations.animation.logger') as mock_logger:
            ...
            mock_logger.debug.assert_any_call("Stopping animation: ConcreteAnimation")
            mock_logger.debug.assert_any_call("Animation ConcreteAnimation forcefully stopping.")
