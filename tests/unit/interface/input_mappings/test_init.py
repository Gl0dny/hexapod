...
class TestInputMappingsInit:
    ...
    def test_concrete_mappings_are_not_abstract(self):
        ...
        assert (
            not hasattr(DualSenseUSBMapping, "__abstractmethods__")
            or len(DualSenseUSBMapping.__abstractmethods__) == 0
        )
        assert (
            not hasattr(DualSenseBluetoothMapping, "__abstractmethods__")
            or len(DualSenseBluetoothMapping.__abstractmethods__) == 0
        )
    ...
    def test_import_from_submodules(self):
        ...
        from hexapod.interface.input_mappings.dual_sense_usb_mapping import (
            DualSenseUSBMapping,
        )
        ...
        from hexapod.interface.input_mappings.dual_sense_bluetooth_mapping import (
            DualSenseBluetoothMapping,
        )
    ...
    def test_circular_imports_work(self):
        ...
        from hexapod.interface.input_mappings import InputMapping
        from hexapod.interface.input_mappings.base_input_mapping import (
            InputMapping as BaseInputMapping,
        )
