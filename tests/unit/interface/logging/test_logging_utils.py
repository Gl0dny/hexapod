...
from hexapod.interface.logging.logging_utils import (
    clean_logs, override_log_levels, setup_logging
)
...
class TestSetupLogging:
    ...
    def test_setup_logging_custom_log_dir(self, tmp_path):
        ...
        with patch('hexapod.interface.logging.logging_utils.logging.config.dictConfig') as mock_dict_config, \
             patch('hexapod.interface.logging.logging_utils.logging.getLogger') as mock_get_logger, \
             patch('hexapod.interface.logging.logging_utils.rename_thread') as mock_rename_thread, \
             patch('hexapod.interface.logging.logging_utils.atexit.register') as mock_atexit:
            ...
            assert call_args["handlers"]["file_handler"]["filename"] == str(custom_log_dir / "test.log")
    ...
    def test_setup_logging_custom_config_file(self, tmp_path):
        ...
        with patch('hexapod.interface.logging.logging_utils.logging.config.dictConfig') as mock_dict_config, \
            ...
            call_args = mock_dict_config.call_args[0][0]
            assert call_args["handlers"]["file_handler"]["filename"] == "logs/custom.log"
