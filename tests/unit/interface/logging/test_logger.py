...
from hexapod.interface.logging.logger import (
    CustomLogger, get_custom_logger, MyJSONFormatter, VerboseFormatter, 
    ColoredTerminalFormatter, USER_INFO_LEVEL, ODAS_USER_INFO_LEVEL, 
...
class TestGetCustomLogger:
    ...
    def test_get_custom_logger_returns_custom_logger(self):
        ...
        with patch('hexapod.interface.logging.logger.logging.setLoggerClass') as mock_set_class, \
             patch('hexapod.interface.logging.logger.logging.getLogger') as mock_get_logger:
    ...
    def test_get_custom_logger_with_different_names(self):
        ...
        with patch('hexapod.interface.logging.logger.logging.setLoggerClass'), \
             patch('hexapod.interface.logging.logger.logging.getLogger') as mock_get_logger:
...
class TestColoredTerminalFormatter:
    ...
    def test_init_ansi_colors(self):
        ...
        expected_colors = [
            "BLUE", "GREEN", "CYAN", "YELLOW", "RED", "BOLD_RED",
    ...
    def test_init_formats_mapping(self):
        ...
        expected_levels = [
            logging.DEBUG, logging.INFO, USER_INFO_LEVEL, ODAS_USER_INFO_LEVEL,
            GAMEPAD_MODE_INFO_LEVEL, logging.WARNING, logging.ERROR, logging.CRITICAL
        ]
