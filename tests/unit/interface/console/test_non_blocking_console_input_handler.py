...
class TestNonBlockingConsoleInputHandler:
    ...
    def test_run_with_exception_handling(self, input_handler, caplog):
        ...
        with patch('hexapod.interface.console.non_blocking_console_input_handler.select.select') as mock_select:
    ...
    def test_run_with_stdin_readline_exception(self, input_handler, caplog):
        ...
        with patch('hexapod.interface.console.non_blocking_console_input_handler.select.select') as mock_select, \
             patch('hexapod.interface.console.non_blocking_console_input_handler.sys.stdin') as mock_stdin:
