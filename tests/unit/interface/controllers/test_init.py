...
class TestControllersInit:
    ...
    def test_manual_hexapod_controller_import(self):
        ...
        from hexapod.interface.controllers.base_manual_controller import (
            ManualHexapodController,
        )
    ...
    def test_import_star_works(self):
        ...
        public_attrs = [
            attr
            for attr in dir(hexapod.interface.controllers)
    ...
    def test_class_modules_are_correct(self):
        ...
        assert (
            "hexapod.interface.controllers.base_manual_controller"
            in ManualHexapodController.__module__
        )
        assert (
            "hexapod.interface.controllers.gamepad_hexapod_controller"
            in GamepadHexapodController.__module__
        )
        assert (
            "hexapod.interface.controllers.gamepad_led_controllers.gamepad_led_controller"
            in BaseGamepadLEDController.__module__
        )
        assert (
            "hexapod.interface.controllers.gamepad_led_controllers.dual_sense_led_controller"
            in DualSenseLEDController.__module__
        )
    ...
    def test_no_side_effects_on_import(self):
        ...
        with patch(
            "hexapod.interface.controllers.gamepad_hexapod_controller.pygame"
        ) as mock_pygame:
