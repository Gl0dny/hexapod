...
from hexapod.interface.controllers.gamepad_hexapod_controller import (
...
class TestGamepadHexapodController:
    ...
    @patch(
        "hexapod.interface.controllers.gamepad_hexapod_controller.PYGAME_AVAILABLE",
        True,
    )
    ...
    @patch("hexapod.interface.controllers.gamepad_hexapod_controller.pygame")
    @patch(
        "hexapod.interface.controllers.gamepad_hexapod_controller.GamepadHexapodController.find_gamepad"
    )
    def test_init_default_parameters(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
    ...
    def test_init_no_gamepad_found(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, caplog
    ):
    ...
    def test_init_fallback_to_usb(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad, caplog
    ):
    ...
    def test_init_with_led_controller_usb(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
        ...
        assert (
            controller.led_controller is not None
        )  # It creates a DualSenseLEDController instance
    ...
    def test_init_with_led_controller_bluetooth_warning(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad, caplog
    ):
        ...
        assert (
            "Gamepad is in Bluetooth mode: Gamepad LED controller is not supported"
            in caplog.text
        )
    ...
    def test_get_analog_inputs_no_gamepad(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
    ...
    def test_get_button_states(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
        """Test getting button states from gamepad."""
        mock_find_gamepad.return_value = mock_gamepad
        mock_gamepad.get_button.side_effect = [
            True,
            False,
            True,
            False,
        ] * 4  # Various button states
    ...
    def test_get_dpad_states_usb_mode(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
        ...
        result = controller._get_dpad_states(
            controller.input_mapping.get_button_mappings()
        )
    ...
    def test_get_dpad_states_bluetooth_mode(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
    ...
    def test_check_button_press_after_debounce(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
    ...
    def test_on_mode_toggled(
        ...
        mock_led_controller.pulse.assert_called_with(
        ...
        mock_led_controller.pulse.assert_called_with(
            GamepadLEDColor.INDIGO, duration=2.0, cycles=0
        )
    ...
    def test_get_inputs_ps5_button(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
        ...
        controller._get_analog_inputs = Mock(
            return_value={
                "left_x": 0.0,
                "left_y": 0.0,
                "right_x": 0.0,
        ...
        controller._get_button_states = Mock(
            return_value={"ps5": True, "square": False}
        )
    ...
    def test_get_inputs_options_button(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
        ...
        controller._get_button_states = Mock(
            return_value={"options": True, "ps5": False}
        )
    ...
    def test_get_inputs_create_button(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
        ...
        controller._get_button_states = Mock(
            return_value={"create": True, "ps5": False}
        )
    ...
    def test_get_inputs_voice_control_mode(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
    ...
    def test_process_stance_height_l2_r2_single_click(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad, caplog
    ):
    ...
    def test_get_body_control_inputs(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad
    ):
    ...
    def test_get_gait_control_inputs(
        self, mock_find_gamepad, mock_pygame, mock_task_interface, mock_gamepad, caplog
    ):
        ...
        controller.analog_inputs = {"left_x": 0.5, "left_y": -0.3, "right_x": 0.8}
        controller.button_states = {
            "x": False,
            "triangle": False,
            "square": False,
    ...
    def test_cleanup_controller_exception(
        self,
        mock_find_gamepad,
        mock_pygame,
        mock_task_interface,
    ...
    def test_start_initial_animation(
        self,
        mock_find_gamepad,
        mock_pygame,
        mock_task_interface,
