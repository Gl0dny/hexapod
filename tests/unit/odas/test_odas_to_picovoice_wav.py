...
class TestConvertODASToWAV:
    ...
    def test_convert_odas_to_wav_success(self, temp_input_file, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_custom_parameters(self, temp_input_file, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_timeout(self, temp_input_file, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_no_change_detection(self, temp_input_file, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_audio_callback(self, temp_input_file, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_wav_file_configuration(self, temp_input_file, temp_output_file, mock_odas_processor):
        ...
        with patch('hexapod.odas.odas_to_picovoice_wav.ODASAudioProcessor', return_value=mock_odas_processor), \
            ...
            mock_wav_file.setframerate.assert_called_once_with(16000)  # Picovoice sample rate
    
    def test_convert_odas_to_wav_temp_directory_cleanup(self, temp_input_file, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_error_handling(self, temp_input_file, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_file_not_found(self, temp_output_file, mock_odas_processor):
...
class TestMain:
    ...
    def test_main_with_default_args(self):
        ...
        with patch('hexapod.odas.odas_to_picovoice_wav.convert_odas_to_wav') as mock_convert, \
             patch('hexapod.odas.odas_to_picovoice_wav.sys.argv', ['script.py', 'input.raw', 'output.wav']):
    ...
    def test_main_with_custom_args(self):
        ...
        with patch('hexapod.odas.odas_to_picovoice_wav.convert_odas_to_wav') as mock_convert, \
             patch('hexapod.odas.odas_to_picovoice_wav.sys.argv', [
    ...
    def test_main_script_path_calculation(self):
        ...
        with patch('hexapod.odas.odas_to_picovoice_wav.convert_odas_to_wav') as mock_convert, \
            ...
            mock_script_path.resolve.return_value = Path('/project/hexapod/odas/odas_to_picovoice_wav.py')
    ...
    def test_main_help_message(self):
        ...
        with patch('hexapod.odas.odas_to_picovoice_wav.sys.argv', ['script.py', '--help']), \
             pytest.raises(SystemExit):
            main()
    
    def test_main_missing_required_args(self):
        """Test that main function handles missing required arguments."""
        with patch('hexapod.odas.odas_to_picovoice_wav.sys.argv', ['script.py']), \
             pytest.raises(SystemExit):
            main()
    
    def test_main_invalid_sample_rate(self):
        """Test that main function handles invalid sample rate."""
        with patch('hexapod.odas.odas_to_picovoice_wav.sys.argv', [
...
class TestEdgeCases:
    ...
    def test_convert_odas_to_wav_empty_file(self, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_large_file(self, temp_output_file, mock_odas_processor):
    ...
    def test_convert_odas_to_wav_processor_error(self, temp_input_file, temp_output_file):
    ...
    def test_convert_odas_to_wav_wav_file_error(self, temp_input_file, temp_output_file, mock_odas_processor):
