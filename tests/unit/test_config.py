...
class TestConfig:
    ...
    def test_init_without_config_file(self):
        ...
        with patch('hexapod.config.load_dotenv') as mock_load_dotenv, \
    ...
    def test_init_without_env_variable(self):
        ...
        with patch('hexapod.config.load_dotenv'), \
...
class TestCreateConfigParser:
    ...
    def test_create_config_parser(self):
        ...
        assert parser.description == "Hexapod Voice Control System - Picovoice Configuration"
