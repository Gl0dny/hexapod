...
class TestRecorder:
    ...
    def test_start_recording_default(self, recorder):
        ...
        with (
            patch("time.strftime", return_value="20231201_120000"),
    ...
    def test_stop_recording_continuous(self, recorder):
        ...
        with (
            patch.object(
                recorder, "_save_recording_audio_record", return_value="saved_file.wav"
            ),
...
class TestIntentDispatcher:
    ...
    def test_dispatch_valid_intent(self, intent_dispatcher):
        ...
        intent_dispatcher.intent_handlers["test_intent"].assert_called_once_with(
            {"param": "value"}
        )
