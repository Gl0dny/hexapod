...
from hexapod.task_interface.tasks.sound_source_localization import (
...
class TestSoundSourceLocalizationTask:
    ...
    def test_execute_task_success(
        ...
        with (
            patch(
                "hexapod.task_interface.tasks.sound_source_localization.logger"
            ) as mock_logger,
    ...
    def test_execute_task_exception_handling(
        ...
        with (
            ...
            assert "Sound source localization task failed" in str(
    ...
    def test_execute_task_odas_processor_cleanup(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
    ...
    def test_execute_task_odas_processor_hasattr_check(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
    ...
    def test_execute_task_wait_loop(
        ...
        with (
            ...
            patch(
                "hexapod.task_interface.tasks.sound_source_localization.time.sleep"
            ) as mock_sleep,
        ):
    ...
    def test_execute_task_initialization_sequence(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
    ...
    def test_execute_task_logging_sequence(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
        ...
        with (
            ...
            assert any(
                "SoundSourceLocalizationTask started" in call for call in call_strings
            )
            assert any(
                "SoundSourceLocalizationTask completed" in call for call in call_strings
            )

    def test_execute_task_stop_event_handling(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
    ...
    def test_execute_task_threading_compatibility(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
        ...
        with (
            patch("hexapod.task_interface.tasks.sound_source_localization.logger"),
            patch("hexapod.task_interface.tasks.sound_source_localization.time.sleep"),
        ):
    ...
    def test_execute_task_exception_during_odas_start(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
    ...
    def test_execute_task_exception_during_odas_close(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
    ...
    def test_execute_task_multiple_executions(
        self,
        sound_localization_task,
        mock_hexapod,
        mock_lights_handler,
