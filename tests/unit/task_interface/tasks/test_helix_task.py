...
class TestHelixTask:
    ...
    def test_perform_helix_success(self, helix_task, mock_hexapod):
        ...
        with patch('hexapod.task_interface.tasks.helix_task.logger') as mock_logger:
            ...
            assert mock_hexapod.move_all_legs_angles.call_count == 4  # 2 repetitions * 2 positions each
    ...
    def test_perform_helix_stop_event_during_position_change(self, helix_task, mock_hexapod):
    ...
    def test_execute_task_success(self, helix_task, mock_hexapod, mock_lights_handler):
        ...
        with patch.object(helix_task, '_perform_helix'), \
            ...
            mock_hexapod.wait_until_motion_complete.assert_called_with(helix_task.stop_event)
    ...
    def test_execute_task_exception_handling(self, helix_task, mock_hexapod, mock_lights_handler):
        """Test exception handling during helix task execution."""
        # Make _perform_helix raise an exception
        with patch.object(helix_task, '_perform_helix', side_effect=Exception("Helix failed")), \
             patch('hexapod.task_interface.tasks.helix_task.logger') as mock_logger:
    ...
    def test_helix_positions_calculation(self, helix_task, mock_hexapod):
        ...
        mock_hexapod.current_leg_angles = [
            ...
            (13.0, 23.0, 33.0), (14.0, 24.0, 34.0), (15.0, 25.0, 35.0)
        ]
