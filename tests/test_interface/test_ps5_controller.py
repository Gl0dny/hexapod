...
def test_controller_functionality():
    ...
    for i in range(joystick_count):
        ...
        print("  [3] L2: -1 (not pressed) to +1 (fully pressed)")
        print("  [4] R2: -1 (not pressed) to +1 (fully pressed)")
        print("  [5] Right Y: -1 (up) to +1 (down) - INVERTED")
        print("Format: [Left X, Left Y, Right X, L2, R2, Right Y]")
        ...
        print("  [13] Touchpad")
        print("  [14] Mute")
        print("Format: [Square, X, Circle, Triangle, L1, R1, L2, R2, Create, Options, L3, R3, PS5, Touchpad, Mute]")
