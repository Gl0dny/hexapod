...
class StreamODASAudioTask(Task):
    ...
    def __init__(
        ...
        self.remote_script_path = "/Users/gl0dny/workspace/hexapod/src/odas/streaming_odas_audio_player.py"
    ...
    def _verify_ssh_connection(self) -> bool:
        ...
        try:
            ...
            logger.error(f"SSH authentication failed for {self.remote_user}@{self.remote_host}")
            return False
    ...
    def _start_remote_streaming(self) -> None:
        ...
        try:
            ...
            if result != 'exists':
                raise Exception(f"Streaming script not found at {self.remote_script_path}")
