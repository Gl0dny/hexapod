...
def convert_raw_to_wav(
    ...
    print(f"Using ODAS postfiltered/separated defaults: {sample_rate} Hz, {channels} channels, {bit_depth}-bit")
...
def main():
    parser = argparse.ArgumentParser(description='Play WAV files and optionally convert raw ODAS audio to WAV')
    parser.add_argument('audio_file', help='Path to audio file (WAV or raw)')
    parser.add_argument('--convert', action='store_true',
                       help='Convert raw file to WAV before playing')
